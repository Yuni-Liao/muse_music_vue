<template>
  <div class="prodmgmt_box">
    ...
    <Button
      type="primary"
      @click.stop="addProd(row)"
      style="width: 100px; margin-bottom: 1%; margin-left: 70%"
      >新增商品</Button
    >
    ...
    <Table
      highlight-row
      stripe
      class="prodmgmt_table cellHeight"
      width="1000"
      :columns="columns"
      :data="productData"
    >
      ...
      <template #upDownBtn="{ row }">
        <Switch
          v-model="row.show_stat"
          @on-change="toggleBtn(row)"
          false-color="#ff4949"
          true-color="#13ce66"
          :before-change="prodBeforeChange"
          true-value="1"
          false-value="0"
        />
      </template>
  ...
  <div v-if="editBox == true" class="editprod obj_Radius">
    ...
    <div class="uploadblock">
      <label for="fileimg">
        ...
        />
        <img
          v-if="editItem.prod_pic == null"
          :src="`${publicPath}image/ShopImage/shop_album0.jpg`"
        />
        <img
          v-else-if="editItem.prod_pic != null && editItem.updateimg == false"
  ...
  <div v-if="addBox == true" class="addprod obj_Radius">
    ...
    <div class="uploadblock">
      <label for="addfileimg">
        ...
        />
        <img
          v-if="addItem.prod_pic == null"
          :src="`${publicPath}image/ShopImage/shop_album0.jpg`"
        />
        <img
          v-else-if="addItem.prod_pic != null && addItem.updateimg == false"
