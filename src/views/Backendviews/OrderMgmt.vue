<template>
    <div class="ordermgmt_box">
        <h1>周邊販售管理 | 訂單管理</h1>
        <Input v-model="value3" placeholder="輸入訂單編號或會員" style="width: 180px; margin-bottom: 1%; margin-left: 58%;">
        <Input v-model="value" />
        <template #append>
...
<!-- 圖標統一先放編輯的, 要寫判斷, 決定給哪個圖標 -->
<!-- 下拉篩選單還沒做 -->

<style scoped lang="scss">
@import "~@/assets/scss/page/Backend/ordermgmt.scss";
</style>
