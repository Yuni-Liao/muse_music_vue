<template>
  ...
  <main class="singleAlbum">
    ...
    <div class="banner" v-for="albumItem in album" :key="albumItem.id">
      ...
      <img
        class="backPic"
        :src="`${publicPath}dataimage/album/${albumItem.albumpic}`"
    ...
    <section class="inner">
      ...
      <div class="mainInf" v-for="albumItem in album" :key="albumItem.id">
        <div class="singerInf">
          <router-link
            :to="`/home/profilepage/${albumItem.singer_id}`"
            class="singer"
          >
            <div class="singerPic">
              <img
                :src="`${publicPath}dataimage/member/${albumItem.singerpic}`"
                :alt="albumItem.singer"
              />
            </div>
            ...
            <ol class="musicTable">
              ...
              <li v-for="(item, index) in songs" :key="id" class="songArea">
                ...
                <div class="btnArea">
                  <!-- 更多_按鈕 -->
                  <ShareBtn></ShareBtn>
                  <AddSlBtn :addSlSid="item.id"></AddSlBtn>
                  <AddFavBtn></AddFavBtn>
                </div>
              </li>
            </ol>
