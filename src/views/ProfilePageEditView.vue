      ...
      <div class="page-content">
        <div v-show="activeTab === 1" class="page">
          <form class="form1">
            <div class="form-group">
              ...
              <input type="text" style="" id="name" v-model="member[0].mem_name" />
            </div>
        ...
        <div v-show="activeTab === 3" class="page">
          <div class="top">
            ...
            <!-- 歌曲搜尋 -->
            <label class="search" for="songsearch"><input type="search" v-model.lazy.trim="searchsong" id="songsearch" />
              <button>
              ...
              <tr v-for="(item, index) in filterprofileSongs" :key="item.s_id">
                ...
                <td class="edit">
                  <button @click="
                    ...
                    ">
                    <fontAwesome v-if="item.s_stat == 1 && item.show_stat == 1" :icon="['fas', 'pen']"
                      style="color: #fdfbfb" />
                  </button>
                </td>
              </tr>
        ...
        <div v-show="activeTab === 4" class="page">
          <div class="top">
            ...
            <!-- 專輯搜尋 -->
            <label class="search" for="albumsearch"><input type="search" v-model.lazy.trim="searchalbum"
                id="albumsearch" />
              <button>
                <img alt="search_icon" :src="`${publicPath}image/icon/search.svg`" /></button></label>
          </div>
          <table class="song-table">
            ...
            <tbody>
              <tr v-for="(item, index) in filterprofileAlbum" :key="item.alb_id">
                <td class="timg">
                  <div class="pic">
