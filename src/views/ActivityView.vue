<template>
  ...
  <div class="wave">
    ...
    >
      <path
        ...
        stroke="white"
        stroke-width="3"
        stroke-dasharray="0,0,0,812.5340576171875"
      >
        <animate
          attributeType="XML"
      ...
      <path
        ...
        stroke="white"
        stroke-width="3"
        stroke-dasharray="0,0,0,812.5339965820312"
      >
        <animate
          attributeType="XML"
          attributeName="stroke-dasharray"
      ...
      <path
        ...
        stroke="white"
        stroke-width="3"
        stroke-dasharray="0,0,0,812.5308227539062"
      >
        <animate
          attributeType="XML"
          attributeName="stroke-dasharray"
    ...
    <div class="outMonthTab">
      ...
      <ul class="monthTab">
        <li
          ...
          :style="{ color: selectedMonth === month ? textColor : '#fff' }"
        >
          {{ month }}
        </li>
      </ul>
      ...
      <ul>
        <li
          @click="
            ...
            textColor = '#74EBD5';
          "
          :style="{ color: selectedArea === '全部' ? textColor : '#fff' }"
        >
          全部
        </li>
        <li
          @click="
            ...
            textColor = '#74EBD5';
          "
          :style="{ color: selectedArea === '北部' ? textColor : '#fff' }"
        >
          北部
        </li>
        <li
          @click="
            ...
            textColor = '#74EBD5';
          "
          :style="{ color: selectedArea === '中部' ? textColor : '#fff' }"
        >
          中部
        </li>
        <li
          @click="
            ...
            textColor = '#74EBD5';
          "
          :style="{ color: selectedArea === '南部' ? textColor : '#fff' }"
        >
          南部
        </li>
        <li
          @click="
            ...
            textColor = '#74EBD5';
          "
          :style="{ color: selectedArea === '東部' ? textColor : '#fff' }"
        >
          東部
        </li>
      </ul>
  ...
  <div class="areaInfoContainer">
    ...
    <div class="infoWrapper">
      <div v-if="filteredNews.length === 0" class="noActivity">
        <h1>目前沒有演出活動!</h1>
      </div>
      <div
        v-else
        class="activityInfo"
        v-for="(news, id) in filteredNews"
        :key="news.news_id"
      >
        <div class="calender">
