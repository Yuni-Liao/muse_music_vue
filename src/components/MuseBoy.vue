<template>
  <div class="museboybox">
    <canvas id="museboy"> </canvas>
  </div>
</template>
...
export default {
  mounted() {
    // 跟 HTML 畫面產生關聯
    let canvas = document.getElementById("museboy");
    ...
    function drawing() {
      ...
      context.lineTo(210, 330);
      context.lineTo(180, 330);
      context.lineTo(180, 310);
