<template>
  ...
  <div class="player" v-if="playerOpen" ref="player">
    ...
    <div class="player_right">
      ...
      <img
        v-if="!isMuted"
        src="/image/icon/volume.svg"
        alt=""
        @click="toggleMute"
      />
      <img
        v-if="isMuted"
        src="/image/icon/muted.svg"
        alt=""
        @click="toggleMute"
      />
      <input
    ...
    <div class="modal-content">
      <div class="playerTop">
        ...
        <div class="playerTab">
          ...
          <h3
            ...
            :style="{ color: showLyrics ? '#74EBD5' : 'white' }"
          >
            歌詞
          </h3>
        </div>
      ...
      <div class="playerBottom">
        ...
        <div v-show="showLyrics" class="lyricsSection">
          <p>
            Tryin' my best to take it slowly To play it cool and keep it low key
            But I'm just a man I ain't a priest My mind's stuck on one thing And
            it ain't exactly holy No, it won't ever be the time to Cross that
            line with you But if only you knew We'd be causin' a commotion No
            more hopin' I leave my girl You leave your man Show you my world
            Drink your potion Unlimited oxytocin, Oh! I can't fake it Girl, I'm
            breaking Tension's got me Tryin' my best to take it slowly To play
            it cool and keep it low key But I'm just a man I ain't a priest My
            mind's stuck on one thing And it ain't exactly holy No, it won't
            ever be the time to Cross that line with you But if only you knew
            We'd be causin' a commotion No more hopin' I leave my girl You leave
            your man Show you my world Drink your potion Unlimited oxytocin, Oh!
            I can't fake it Girl, I'm breaking Tension's got me
          </p>
        </div>
      </div>
    </div>
