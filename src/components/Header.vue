    ...
    <header headroom headroom--unpinned>
        ...
        <nav>
            <div class="header_nav_left">
                ...
                <router-link to="/home/find">探索</router-link>
                <router-link to="/home/ranking">排行榜</router-link>
                <router-link to="/home/shop">周邊販售</router-link>
            ...
            <div class="header_nav_right">
                ...
                <div class="user_dropdown_reaction">
                    ...
                    <div class="user_dropdown">
                        ...
                        <p>我的音樂庫</p>
                        <router-link to="/home"><img src="~@/assets/image/icon/clock.png" alt="" />播放紀錄</router-link><br />
                        <router-link to="/home/mysonglist"><img src="~@/assets/image/icon/list.png"
                                alt="" />我的歌單</router-link><br />
                        <router-link to="/home"><img src="~@/assets/image/icon/heart.png" alt="" />我的最愛</router-link><br />
                        <router-link to="/home"><img src="~@/assets/image/icon/targeticon.png" alt="" />我的追蹤</router-link>
